...
$query = "SELECT * FROM product WHERE product_Id='42'";
  $sql=mysqli_query($con,$query) or die(mysqli_error());
      while($row = mysqli_fetch_assoc($sql)){?>
        <?php echo '<img src="data:image/jpeg;base64,'.base64_encode( $row['product_Picture'] ).'"/>'; ?>
  <?php } ?>
                                      </div>
                                    </li>
                                  </ul>
                                <div class="span7">
                                  ...
                                  <table class="table table-striped">
				                                <tbody>
				                                      <tr class="techSpecRow"><td class="techSpecTD1">Alternator Fan:</td><td class="techSpecTD2">Internal</td></tr>
				                                      <tr class="techSpecRow"><td class="techSpecTD1">Alternator Output Amperage (A):</td><td class="techSpecTD2">100</td></tr>
				                                      <tr class="techSpecRow"><td class="techSpecTD1">Alternator Regulation:</td><td class="techSpecTD2">Integral</td></tr>
				                                      <tr class="techSpecRow"><td class="techSpecTD1">Pulleys Included:</td><td class="techSpecTD2">1</td></tr>
				                                      <tr class="techSpecRow"><td class="techSpecTD1">Vehicle System Voltage:</td><td class="techSpecTD2">12V</td></tr>
				                                      <tr class="techSpecRow"><td class="techSpecTD1">Available Cars:</td><td class="techSpecTD2">Toyota:Camry, Corolla, MatrixScion: xB(8), Pontiac: Vibe 2WD (2)Vibe AWD (2)Vibe GT 2WD (1)</td></tr>
				                                 </tbody>
				                          </table>
